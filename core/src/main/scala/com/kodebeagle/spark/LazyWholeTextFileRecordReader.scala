...
/**
  ...
  */
// scalastyle:off
class LazyWholeTextFileRecordReader(
                                     split: CombineFileSplit,
                                     context: TaskAttemptContext,
                                     index: Integer)
  extends RecordReader[Text, () => Text] with Configurable with Serializable{
  ...
  override def nextKeyValue(): Boolean = {
    if (!processed) {
      value = () => {
        ...
        val value = new Text(innerBuffer)
...
/**
  ...
  * RecordReaders.
  */
class LazyCombineFileRecordReader[K, V](
                                         split: InputSplit,
                                         context: TaskAttemptContext,
